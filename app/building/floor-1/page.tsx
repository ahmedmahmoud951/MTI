    ...
    <motion.div
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 mb-3">
          <span className="text-xl text-blue-400 font-semibold">Floor 1</span>
          <span className="text-gray-600">|</span>
          <span className="text-gray-400">Innovation & Research Center</span>
        </div>
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold cyber-text mb-6">Welcome to Our Engineering Labs</h2>
          <p className="text-gray-300 mb-6 leading-relaxed text-lg">
            This floor houses our state-of-the-art engineering facilities where innovation comes to life. Our teams work on cutting-edge projects utilizing the latest technology and collaborative work environments.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            >
              ...
              <p className="text-blue-300 font-bold mb-2 text-lg">Research & Development</p>
              <p className="text-gray-400">Cutting-edge projects and innovation labs</p>
            </motion.div>
            <motion.div 
              whileHover={{ scale: 1.05, y: -5 }}
              className="glass-card p-6 rounded-lg border border-blue-400/50 cursor-pointer group overflow-hidden"
            >
              ...
              <p className="text-blue-300 font-bold mb-2 text-lg">Team Collaboration</p>
              <p className="text-gray-400">Modern collaborative workspaces</p>
            </motion.div>
            <motion.div 
              whileHover={{ scale: 1.05, y: -5 }}
              className="glass-card p-6 rounded-lg border border-blue-400/50 cursor-pointer group overflow-hidden"
            >
              <p className="text-2xl mb-3 group-hover:scale-125 transition-transform duration-300 inline-block">💻</p>
              <p className="text-blue-300 font-bold mb-2 text-lg">Advanced Technology</p>
              <p className="text-gray-400">Latest tools and equipment</p>
            </motion.div>
            <motion.div 
              whileHover={{ scale: 1.05, y: -5 }}
              className="glass-card p-6 rounded-lg border border-blue-400/50 cursor-pointer group overflow-hidden"
            >
              <p className="text-2xl mb-3 group-hover:scale-125 transition-transform duration-300 inline-block">⭐</p>
              <p className="text-blue-300 font-bold mb-2 text-lg">Excellence</p>
              <p className="text-gray-400">Commitment to quality and innovation</p>
            </motion.div>
          </div>
        </motion.div>
